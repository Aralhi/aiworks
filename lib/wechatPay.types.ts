...
export interface NativeWechatPaySceneInfo {
  /**
...
export interface H5WechatPaySceneInfo {
  /**
   * 用户的客户端IP，支持IPv4和IPv6两种格式的IP地址。
   * 示例值：14.23.150.211
   */
...
export interface JSAPIPrePayRequestParams {
  /**
   ...
   * 支付场景描述
   */
  scene_info?: NativeWechatPaySceneInfo;
...
export interface H5PrePayRequestParams {
   ...
   * 支付场景描述
   */
  scene_info?: H5WechatPaySceneInfo;
